...
function init() {
  ...
  if (!fs.existsSync(envPath)) {
    console.log('⚠️ No .env file found at the project root. Creating from example...');
    try {
      ...
      if (fs.existsSync(exampleEnvPath)) {
        ...
        console.log('⚠️ No .env.example file found. You will need to create a .env file manually.');
      }
    } catch (error) {
  ...
  try {
    ...
    console.log('💡 Make sure your database is running and DATABASE_URL is correctly set in your .env file');
    process.exit(1);
  }
